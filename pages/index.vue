<template>
    <main class="pattern">
                ...
                <div class="container px-4 mx-auto sm:px-6">
                    <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                        <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                            <a href="#">
                                <span class="sr-only">Merakiui</span>

                                <svg  class="w-auto h-8 sm:h-9" viewBox="0 0 474 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
                            <span class="inline-flex rounded-md shadow">
                                <a href="#" class="inline-flex items-center px-4 py-2 text-base font-medium text-blue-500 bg-white border border-transparent rounded-md hover:bg-gray-50"> Log in </a>
                            </span>
                        </div>
                    </nav>
                </div>

                <main class="container px-4 mx-auto mt-16 sm:mt-28">
                    <div class="text-center">
                        <h1 class="text-3xl font-medium text-gray-800 font-dm-mono sm:text-5xl">
                            Free Elegant <span class="text-blue-500 ">Tailwind CSS</span> Components
                        </h1>

                        <p class="max-w-md mx-auto mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"><span class="font-medium text-blue-500 ">220</span> Tailwind CSS Components That Support RTL Languages & Fully Responsive Based On Flexbox & CSS Grid With Elegant Dark Mode.</p>
                        
                        <div class="max-w-lg mx-auto mt-5 sm:flex sm:justify-center md:mt-8">
                            <div class="rounded-md shadow">
                                <a href="/components" class="flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white rounded-md bg-gradient-to-r from-blue-400 to-blue-500">
                                     Browse Components
                                </a>
                            </div>
                            
                            <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                                <a href="/premium" class="flex items-center justify-center w-full px-8 py-3 space-x-2 text-base font-medium text-blue-500 transition-colors duration-300 bg-white rounded-md hover:bg-gray-50"> 
        ...
        <div class="container px-4 py-20 mx-auto sm:px-6">
            <!-- <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl font-extrabold text-gray-800">All-in-one platform</h2>
            ...
            <center-content class="mt-12"></center-content>
            <grid-list class="mt-12"></grid-list>
            <full-page-with-image class="mt-12"></full-page-with-image> -->

            <div class="max-w-md mx-auto sm:max-w-3xl lg:max-w-full">
                ...
                <div class="relative">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <input id="cta-email" type="email" class="block w-full px-5 py-3 text-base text-gray-800 placeholder-gray-500 border border-transparent rounded-md shadow-sm focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-500" placeholder="Enter your email">
                    </div>
        ...
        <footer>
            <div class="container px-4 py-12 mx-auto overflow-hidden sm:px-6 lg:px-8">
                ...
                <div class="px-5 py-2">
                    <a href="#" class="text-base text-gray-500 hover:text-gray-800"> About </a>
                </div>

                <div class="px-5 py-2">
                    <a href="#" class="text-base text-gray-500 hover:text-gray-800"> Blog </a>
                </div>

                <div class="px-5 py-2">
                    <a href="#" class="text-base text-gray-500 hover:text-gray-800"> Jobs </a>
                </div>

                <div class="px-5 py-2">
                    <a href="#" class="text-base text-gray-500 hover:text-gray-800"> Press </a>
                </div>

                <div class="px-5 py-2">
                    <a href="#" class="text-base text-gray-500 hover:text-gray-800"> Accessibility </a>
                </div>

                <div class="px-5 py-2">
                    <a href="#" class="text-base text-gray-500 hover:text-gray-800"> Partners </a>
                </div>
                </nav>
...
<script>
import CenterContent from "../components/ui/Heros/CenterContentWithNewsletter.vue";
import GridList from "../components/ui/Features/GridList.vue";
import FullPageWithImage from "../components/ui/Authentication/FullPageWithImage.vue";

export default {
    components: { CenterContent, GridList, FullPageWithImage },
